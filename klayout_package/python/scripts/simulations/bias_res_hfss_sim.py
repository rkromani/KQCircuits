...
parser = argparse.ArgumentParser(description="Run HFSS eigenmode simulations on bias resonator")
...
parser.add_argument("--sweep-override", type=str, default=None,
                    help="Override sweep parameters as JSON (e.g., '{\"l_length\": [4000, 4500]}')")
...
class BiasResHfssSim(BaseSimClass):
...
sweep_params = {
    ...
    "l_coupling_distance": [200], 
    "include_capacitor": [False],  # Sweep with and without capacitor to see effect on modes
}
