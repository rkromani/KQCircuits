...
# from the BiasResonator2 element and stores them in extra_json_data
SimClass = get_acrl_sim_class(BiasResonator2)

# Simulation parameters for Q3D ACRL measurement
sim_parameters = {
    "name": "bias_resonator_2_acrl",
