...
class LumpedRes2Chip(Chip):
    ...
    def build(self):
        ...
        res_params = [{"l_coupling_distance": 20, "l_coupling_length": 40, "l_tot_length": 4725},
                      {"l_coupling_distance": 20, "l_coupling_length": 300, "l_tot_length": 4725}, 
                      {"l_coupling_distance": 20, "l_coupling_length": 300, "l_tot_length": 4500}, 
                      {"l_coupling_distance": 20, "l_coupling_length": 300, "l_tot_length": 4300}, ]
        i = 0
        while i < n_res:
            if i < n_res/2:
            ...
            if i not in cap_to_skip:
                ...
                if i % 2 == 0:
                    self.insert_cell(
                            WaveguideComposite,
                            nodes=[
                                Node(self.refpoints[f'CAP{i}b_bottom_port']),
                                Node((self.refpoints[f'CAP{i}b_bottom_port'].x, self.refpoints[f'CAP{i}b_bottom_port'].y - 10))
                            ],
                            a=0,
                        )
