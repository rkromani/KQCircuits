...
class ChipSpikeRes(Chip):
    ...
    launcher_indent = Param(pdt.TypeDouble, "Chip edge to pad port", 850, unit="μm")
    launcher_y_position = Param(pdt.TypeDouble, "Launcher vertical position", 5588, unit="μm")
    ...
    bias_rail_y = Param(pdt.TypeDouble, "Y position of bias rail", 400, unit="μm")
    ...
    def build(self):
        ...
        coupling_spacings = np.arange(6, 20, 2)
        i = 0
        while i < n_res:
            if i < n_res/2:
